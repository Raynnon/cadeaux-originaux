...
function App() {
  return (
    <div>
      <Header />
      <Row as="main" id="product" className="mt-4" fluid>
        <Col xs={5}>
          <Image
        ...
        <Col xs={{ span: 6, offset: 1 }} as="section">
          ...
          <p id="product-description">
            ...
            quam, sed venenatis ex tincidunt id. Sed laoreet ipsum non eleifend
            tempus. Sed sollicitudin ante vitae neque gravida, in dictum purus
            placerat. Nulla leo metus, pretium sed luctus et, rutrum in urna.
